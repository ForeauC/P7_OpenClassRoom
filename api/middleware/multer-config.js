...
const storage = multer.diskStorage({
    // Fonction de multer pour enregistrer sur le disk. Nous créons une constante storage , à passer à multer comme configuration, qui contient la logique nécessaire pour indiquer à multer où enregistrer les fichiers entrants.
